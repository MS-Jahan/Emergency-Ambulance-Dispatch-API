...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    x(z13, "PrismaClientKnownRequestError");
...
`);
    ...
    function $r({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z13(um(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new V(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function um(e, r) {
      let t = e.message;
...
`;
    ...
    async function Ft(e, r) {
      ...
      if (n.type === "QueryEngineError") throw new z13(n.body.message, { code: n.body.error_code, clientVersion: r });
    ...
    var Qr = class {
      ...
      async transaction(r, t, n) {
        ...
        if (xf(a)) {
          ...
          throw l ? l.error : new z13(a.message, { code: a.error_code, clientVersion: this.config.clientVersion, meta: a.meta });
    ...
    var ei = class {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = Tn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          ...
          throw new z13(l, { code: r.code, clientVersion: this.client._clientVersion, meta: u, batchRequestIdx: r.batchRequestIdx });
        } else {
...
var require_client = __commonJS({
  "node_modules/.prisma/client/index.js"(exports2) {
    ...
    exports2.Prisma.DriverProfileScalarFieldEnum = {
      id: "id",
      userId: "userId",
    ...
    exports2.Prisma.AmbulanceScalarFieldEnum = {
      id: "id",
    ...
    exports2.Prisma.HospitalScalarFieldEnum = {
      id: "id",
      name: "name",
      address: "address",
      lat: "lat",
    ...
    exports2.Prisma.EmergencyRequestScalarFieldEnum = {
      id: "id",
      patientId: "patientId",
    ...
    exports2.Prisma.RequestStatusLogScalarFieldEnum = {
      id: "id",
      requestId: "requestId",
      actorId: "actorId",
    ...
    exports2.DriverStatus = exports2.$Enums.DriverStatus = {
      AVAILABLE: "AVAILABLE",
      ON_TRIP: "ON_TRIP",
      OFFLINE: "OFFLINE"
    };
    exports2.AmbulanceType = exports2.$Enums.AmbulanceType = {
      BASIC: "BASIC",
      ICU: "ICU",
      CARDIAC: "CARDIAC"
    };
    exports2.AmbulanceStatus = exports2.$Enums.AmbulanceStatus = {
      AVAILABLE: "AVAILABLE",
      ON_TRIP: "ON_TRIP",
      MAINTENANCE: "MAINTENANCE"
    };
    exports2.RequestPriority = exports2.$Enums.RequestPriority = {
      CRITICAL: "CRITICAL",
      HIGH: "HIGH",
      NORMAL: "NORMAL"
    };
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/ubuntu/projects/ph-l2-b7-asnmnt-6/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/ubuntu/projects/ph-l2-b7-asnmnt-6/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
      ...
      "inlineSchemaHash": "cff89b4f3d0324fe706949df9827863a35c7b2f03f99c11344b235e0197237dd",
      "copyEngine": true
    };
    var fs = require("fs");
    ...
    config.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"password","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"phone","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"role","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Role","nativeType":null,"default":"PATIENT","isGenerated":false,"isUpdatedAt":false},{"name":"googleId","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"isVerified","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Boolean","nativeType":null,"default":false,"isGenerated":false,"isUpdatedAt":false},{"name":"deletedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"driverProfile","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DriverProfile","nativeType":null,"relationName":"DriverProfileToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"emergencyRequests","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"patientRequests","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"statusLogs","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"RequestStatusLog","nativeType":null,"relationName":"RequestStatusLogToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"payments","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Payment","nativeType":null,"relationName":"PaymentToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"feedbackGiven","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Feedback","nativeType":null,"relationName":"feedbackPatient","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"feedbackReceived","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Feedback","nativeType":null,"relationName":"feedbackDriver","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"refreshTokens","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"RefreshToken","nativeType":null,"relationName":"RefreshTokenToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"assignedRequests","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"driverRequests","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"DriverProfile":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"DriverProfileToUser","relationFromFields":["userId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"licenseNumber","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"status","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DriverStatus","nativeType":null,"default":"OFFLINE","isGenerated":false,"isUpdatedAt":false},{"name":"currentLat","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Float","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"currentLng","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Float","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"ambulanceId","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"ambulance","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Ambulance","nativeType":null,"relationName":"AmbulanceToDriverProfile","relationFromFields":["ambulanceId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Ambulance":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"plateNumber","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"type","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"AmbulanceType","nativeType":null,"default":"BASIC","isGenerated":false,"isUpdatedAt":false},{"name":"status","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"AmbulanceStatus","nativeType":null,"default":"AVAILABLE","isGenerated":false,"isUpdatedAt":false},{"name":"homeHospitalId","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"homeHospital","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Hospital","nativeType":null,"relationName":"AmbulanceToHospital","relationFromFields":["homeHospitalId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"deletedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"drivers","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DriverProfile","nativeType":null,"relationName":"AmbulanceToDriverProfile","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"requests","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"AmbulanceToEmergencyRequest","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Hospital":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"address","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"lat","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Float","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"lng","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Float","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"phone","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"deletedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"ambulances","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Ambulance","nativeType":null,"relationName":"AmbulanceToHospital","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"destinationRequests","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"EmergencyRequestToHospital","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"EmergencyRequest":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"patientId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"patient","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"patientRequests","relationFromFields":["patientId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"pickupAddress","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"pickupLat","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Float","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"pickupLng","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Float","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"priority","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"RequestPriority","nativeType":null,"default":"NORMAL","isGenerated":false,"isUpdatedAt":false},{"name":"status","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"RequestStatus","nativeType":null,"default":"PENDING","isGenerated":false,"isUpdatedAt":false},{"name":"ambulanceId","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"ambulance","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Ambulance","nativeType":null,"relationName":"AmbulanceToEmergencyRequest","relationFromFields":["ambulanceId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"driverId","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"driver","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"driverRequests","relationFromFields":["driverId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"destinationHospitalId","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"destinationHospital","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Hospital","nativeType":null,"relationName":"EmergencyRequestToHospital","relationFromFields":["destinationHospitalId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"cancelReason","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"requestedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"assignedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"completedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"statusLogs","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"RequestStatusLog","nativeType":null,"relationName":"EmergencyRequestToRequestStatusLog","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"payments","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Payment","nativeType":null,"relationName":"EmergencyRequestToPayment","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"feedbacks","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Feedback","nativeType":null,"relationName":"EmergencyRequestToFeedback","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"RequestStatusLog":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"requestId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"request","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"EmergencyRequestToRequestStatusLog","relationFromFields":["requestId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"actorId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"actor","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"RequestStatusLogToUser","relationFromFields":["actorId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"fromStatus","kind":"enum","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"RequestStatus","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"toStatus","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"RequestStatus","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"note","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Payment":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"requestId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"request","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"EmergencyRequestToPayment","relationFromFields":["requestId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"patientId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"patient","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"PaymentToUser","relationFromFields":["patientId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"amount","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Decimal","nativeType":["Decimal",["10","2"]],"isGenerated":false,"isUpdatedAt":false},{"name":"currency","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":"usd","isGenerated":false,"isUpdatedAt":false},{"name":"stripeSessionId","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"status","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"PaymentStatus","nativeType":null,"default":"PENDING","isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Feedback":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"requestId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"request","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"EmergencyRequest","nativeType":null,"relationName":"EmergencyRequestToFeedback","relationFromFields":["requestId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"patientId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"patient","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"feedbackPatient","relationFromFields":["patientId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"driverId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"driver","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"feedbackDriver","relationFromFields":["driverId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"rating","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Int","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"comment","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"deletedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"RefreshToken":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"cuid","args":[1]},"isGenerated":false,"isUpdatedAt":false},{"name":"tokenHash","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"RefreshTokenToUser","relationFromFields":["userId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"expiresAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"revokedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{"Role":{"values":[{"name":"PATIENT","dbName":null},{"name":"DRIVER","dbName":null},{"name":"ADMIN","dbName":null}],"dbName":null},"DriverStatus":{"values":[{"name":"AVAILABLE","dbName":null},{"name":"ON_TRIP","dbName":null},{"name":"OFFLINE","dbName":null}],"dbName":null},"AmbulanceType":{"values":[{"name":"BASIC","dbName":null},{"name":"ICU","dbName":null},{"name":"CARDIAC","dbName":null}],"dbName":null},"AmbulanceStatus":{"values":[{"name":"AVAILABLE","dbName":null},{"name":"ON_TRIP","dbName":null},{"name":"MAINTENANCE","dbName":null}],"dbName":null},"RequestPriority":{"values":[{"name":"CRITICAL","dbName":null},{"name":"HIGH","dbName":null},{"name":"NORMAL","dbName":null}],"dbName":null},"RequestStatus":{"values":[{"name":"PENDING","dbName":null},{"name":"ASSIGNED","dbName":null},{"name":"EN_ROUTE_PICKUP","dbName":null},{"name":"PICKED_UP","dbName":null},{"name":"EN_ROUTE_HOSPITAL","dbName":null},{"name":"COMPLETED","dbName":null},{"name":"CANCELLED","dbName":null}],"dbName":null},"PaymentStatus":{"values":[{"name":"PENDING","dbName":null},{"name":"PAID","dbName":null},{"name":"FAILED","dbName":null},{"name":"REFUNDED","dbName":null}],"dbName":null}},"types":{}}');
...
var envSchema = import_zod.z.object({
  ...
  CORS_ORIGIN: import_zod.z.string().default("http://localhost:3000"),
  DATABASE_URL: import_zod.z.string().url(),
  DIRECT_URL: import_zod.z.string().url(),
...
var logger = (0, import_pino.default)({
  ...
  ...process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "test" ? { transport: { target: "pino-pretty" } } : {}
});
...
function zodIssuesToAppError(error) {
  const errors = error.issues.map((issue) => ({
    field: issue.path.map(String).join(".") || void 0,
...
// src/middleware/errorHandler.ts
var GENERIC_500_MESSAGE = "Something went wrong";
...
var globalErrorHandler = (error, _req, res, _next) => {
  ...
  if (error instanceof AppError) {
    ...
    const message = process.env.NODE_ENV === "production" ? GENERIC_500_MESSAGE : error.message;
...
var skipInTests = () => process.env.NODE_ENV === "test";
...
var accessExpiresInSeconds = parseDuration(env.JWT_ACCESS_EXPIRES_IN);
var refreshExpiresInSeconds = parseDuration(env.JWT_REFRESH_EXPIRES_IN);
var refreshExpiry = {
  seconds: refreshExpiresInSeconds,
  ms: refreshExpiresInSeconds * 1e3
};
...
function signRefreshToken(userId) {
  ...
  const token = import_jsonwebtoken.default.sign(payload, env.JWT_REFRESH_SECRET, {
...
function parseDuration(value) {
  ...
  const multiplier = unit !== void 0 ? multipliers[unit] : void 0;
  ...
  return prisma.$transaction(async (tx) => {
    const user = await tx.user.create({
      data: {
        ...
        password: await import_bcryptjs.default.hash(input.password, 10),
        phone: input.phone,
        role: "DRIVER",
        isVerified: true
      },
...
async function updateUserRole(userId, input) {
...
var postDriver = catchAsync(async (req, res) => {
...
var patchUserRole = catchAsync(async (req, res) => {
...
var getAuditLogs = catchAsync(async (req, res) => {
  const result = await listAuditLogs(req.validatedQuery);
  sendResponse(res, { message: "Audit logs fetched", data: result });
});

// src/modules/admin/admin.params.ts
var import_zod5 = require("zod");
var idParamSchema = import_zod5.z.object({
  id: import_zod5.z.string().cuid()
});

// src/modules/admin/admin.validation.ts
var import_zod6 = require("zod");
var createDriverSchema = import_zod6.z.object({
  name: import_zod6.z.string().min(2).max(80),
  email: import_zod6.z.string().email().max(200),
  password: import_zod6.z.string().min(8, "Password must be at least 8 characters").max(72).regex(/[A-Za-z]/, "Password must contain a letter").regex(/[0-9]/, "Password must contain a number"),
  phone: import_zod6.z.string().min(6).max(20),
  licenseNumber: import_zod6.z.string().min(4).max(40)
});
var listUsersQuerySchema = paginationQuerySchema.extend({
  role: import_zod6.z.enum(["PATIENT", "DRIVER", "ADMIN"]).optional(),
  q: import_zod6.z.string().max(120).optional()
});
var updateUserRoleSchema = import_zod6.z.object({
  role: import_zod6.z.enum(["PATIENT", "DRIVER", "ADMIN"])
});
var listAuditLogsQuerySchema = paginationQuerySchema.extend({
  requestId: import_zod6.z.string().cuid().optional()
});
...
// src/modules/ambulances/ambulance.routes.ts
var import_express2 = require("express");

// src/modules/ambulances/ambulance.service.ts
var LIST_SELECT = {
  id: true,
  plateNumber: true,
  type: true,
...
async function createAmbulance(input) {
...
async function listAmbulances(query) {
  ...
  const allowedSortFields = ["plateNumber", "status", "createdAt"];
  const sortField = allowedSortFields.find((f) => f === sortBy) ?? "createdAt";
  const [items, total] = await prisma.$transaction([
...
async function updateAmbulance(id, input) {
...
async function softDeleteAmbulance(id) {
  await getAmbulance(id);
  await prisma.ambulance.update({ where: { id }, data: { deletedAt: /* @__PURE__ */ new Date() } });
}
async function findNearbyAmbulances(query) {
...
// src/modules/ambulances/ambulance.controller.ts
var create = catchAsync(async (req, res) => {
  const ambulance = await createAmbulance(req.body);
  sendResponse(res, { statusCode: 201, message: "Ambulance created", data: { ambulance } });
});
var list = catchAsync(async (req, res) => {
  const result = await listAmbulances(req.validatedQuery);
  sendResponse(res, { message: "Ambulances fetched", data: result });
});
var getOne = catchAsync(async (req, res) => {
  const ambulance = await getAmbulance(req.params.id);
  sendResponse(res, { message: "Ambulance fetched", data: { ambulance } });
});
var update = catchAsync(async (req, res) => {
  const ambulance = await updateAmbulance(req.params.id, req.body);
  sendResponse(res, { message: "Ambulance updated", data: { ambulance } });
});
var remove = catchAsync(async (req, res) => {
  await softDeleteAmbulance(req.params.id);
  sendResponse(res, { message: "Ambulance deleted", data: null });
});
var nearby = catchAsync(async (req, res) => {
  const result = await findNearbyAmbulances(req.validatedQuery);
  sendResponse(res, { message: "Nearby ambulances fetched", data: { items: result } });
});

// src/modules/ambulances/ambulance.validation.ts
var import_zod7 = require("zod");
var createAmbulanceSchema = import_zod7.z.object({
  plateNumber: import_zod7.z.string().min(4).max(20).regex(/^[A-Za-z0-9-]+$/, "Plate number can only contain letters, numbers, and dashes"),
  type: import_zod7.z.enum(["BASIC", "ICU", "CARDIAC"]).default("BASIC"),
  homeHospitalId: import_zod7.z.string().cuid().optional(),
  status: import_zod7.z.enum(["AVAILABLE", "ON_TRIP", "MAINTENANCE"]).optional()
});
var updateAmbulanceSchema = import_zod7.z.object({
  type: import_zod7.z.enum(["BASIC", "ICU", "CARDIAC"]).optional(),
  homeHospitalId: import_zod7.z.string().cuid().nullable().optional(),
  status: import_zod7.z.enum(["AVAILABLE", "ON_TRIP", "MAINTENANCE"]).optional()
});
var listAmbulancesQuerySchema = paginationQuerySchema.extend({
  q: import_zod7.z.string().max(20).optional(),
  status: import_zod7.z.enum(["AVAILABLE", "ON_TRIP", "MAINTENANCE"]).optional(),
  type: import_zod7.z.enum(["BASIC", "ICU", "CARDIAC"]).optional()
});
var nearbyQuerySchema = import_zod7.z.object({
  lat: import_zod7.z.coerce.number().min(-90).max(90),
  lng: import_zod7.z.coerce.number().min(-180).max(180),
  radiusKm: import_zod7.z.coerce.number().min(0.5).max(50).default(10),
  type: import_zod7.z.enum(["BASIC", "ICU", "CARDIAC"]).optional()
});

// src/modules/ambulances/ambulance.routes.ts
var ambulancesRouter = (0, import_express2.Router)();
...
async function issueTokens(user) {
  ...
  const { token: refreshToken2, jti } = signRefreshToken(user.id);
  await prisma.refreshToken.create({
    data: {
      id: jti,
      tokenHash: hashToken(refreshToken2),
      userId: user.id,
...
async function registerUser(input) {
  ...
  const user = await prisma.user.create({
    data: {
      ...
      phone: input.phone,
      role: import_client3.Role.PATIENT,
      isVerified: false
    },
...
async function loginUser(input) {
  ...
  const passwordMatches = await import_bcryptjs2.default.compare(input.password, user.password);
  if (!passwordMatches) {
    throw AppError.unauthorized("Invalid email or password");
  }
...
async function googleLogin(input) {
  const client = new import_google_auth_library.OAuth2Client(env.GOOGLE_CLIENT_ID);
  let ticket;
  try {
...
async function revokeRefreshToken(refreshToken2) {
  if (!refreshToken2) {
    return;
  }
  const stored = await prisma.refreshToken.findUnique({
    where: { tokenHash: hashToken(refreshToken2) }
  });
...
var googleAuth = catchAsync(async (req, res) => {
...
var refreshToken = catchAsync(async (req, res) => {
  const result = await rotateRefreshToken(req.body);
...
var registerSchema = import_zod8.z.object({
  name: import_zod8.z.string().min(2).max(80),
  email: import_zod8.z.string().email().max(200),
  password: import_zod8.z.string().min(8, "Password must be at least 8 characters").max(72).regex(/[A-Za-z]/, "Password must contain a letter").regex(/[0-9]/, "Password must contain a number"),
  phone: import_zod8.z.string().min(6).max(20).optional()
});
var loginSchema = import_zod8.z.object({
  email: import_zod8.z.string().email(),
  password: import_zod8.z.string().min(1)
});
var googleLoginSchema = import_zod8.z.object({
  idToken: import_zod8.z.string().min(20)
});
var refreshTokenSchema = import_zod8.z.object({
  refreshToken: import_zod8.z.string().min(20)
});
var updateProfileSchema = import_zod8.z.object({
  name: import_zod8.z.string().min(2).max(80).optional(),
  phone: import_zod8.z.string().min(6).max(20).optional()
});
...
async function updateMyStatus(userId, input) {
...
async function updateMyLocation(userId, input) {
  const profile = await getProfileOrThrow(userId);
...
var updateStatus = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
  const profile = await updateMyStatus(req.user.id, req.body);
  sendResponse(res, { message: "Driver status updated", data: { profile } });
});
var updateLocation = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
  const location = await updateMyLocation(req.user.id, req.body);
  sendResponse(res, { message: "Driver location updated", data: { location } });
});

// src/modules/drivers/driver.validation.ts
var import_zod9 = require("zod");
var updateDriverStatusSchema = import_zod9.z.object({
  status: import_zod9.z.enum(["AVAILABLE", "ON_TRIP", "OFFLINE"])
});
var updateDriverLocationSchema = import_zod9.z.object({
  lat: import_zod9.z.number().min(-90).max(90),
  lng: import_zod9.z.number().min(-180).max(180)
});

// src/modules/drivers/driver.routes.ts
var driverRouter = (0, import_express4.Router)();
driverRouter.use(authenticate, requireRole("DRIVER"));
driverRouter.get("/me", getMe2);
...
async function createFeedback(patientId, input) {
...
async function listFeedbackForRequest(requestId, requester) {
  const request = await prisma.emergencyRequest.findFirst({
    where: { id: requestId },
...
var create2 = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
  const feedback = await createFeedback(req.user.id, req.body);
  sendResponse(res, { statusCode: 201, message: "Feedback recorded", data: { feedback } });
});
var listForRequest = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
  const items = await listFeedbackForRequest(req.params.requestId, req.user);
  sendResponse(res, { message: "Feedback fetched", data: { items } });
});

// src/modules/feedback/feedback.validation.ts
var import_zod10 = require("zod");
var createFeedbackSchema = import_zod10.z.object({
  requestId: import_zod10.z.string().cuid(),
  rating: import_zod10.z.number().int().min(1).max(5),
  comment: import_zod10.z.string().max(500).optional()
});

// src/modules/feedback/feedback.routes.ts
var feedbackRouter = (0, import_express5.Router)();
feedbackRouter.use(authenticate);
feedbackRouter.post("/", requireRole("PATIENT"), validate({ body: createFeedbackSchema }), create2);
...
async function createHospital(input) {
  return prisma.hospital.create({ data: input, select: LIST_SELECT2 });
}
...
async function updateHospital(id, input) {
  ...
  return prisma.hospital.update({ where: { id }, data: input, select: LIST_SELECT2 });
}
async function softDeleteHospital(id) {
  await getHospital(id);
  await prisma.hospital.update({ where: { id }, data: { deletedAt: /* @__PURE__ */ new Date() } });
}

// src/modules/hospitals/hospital.controller.ts
...
var list2 = catchAsync(async (req, res) => {
  const result = await listHospitals(req.validatedQuery);
  sendResponse(res, { message: "Hospitals fetched", data: result });
});
var getOne2 = catchAsync(async (req, res) => {
...
var remove2 = catchAsync(async (req, res) => {
  await softDeleteHospital(req.params.id);
  sendResponse(res, { message: "Hospital deleted", data: null });
});

// src/modules/hospitals/hospital.validation.ts
var import_zod11 = require("zod");
var createHospitalSchema = import_zod11.z.object({
  name: import_zod11.z.string().min(2).max(120),
  address: import_zod11.z.string().min(5).max(250),
  lat: import_zod11.z.number().min(-90).max(90),
  lng: import_zod11.z.number().min(-180).max(180),
  phone: import_zod11.z.string().min(6).max(20)
});
var updateHospitalSchema = createHospitalSchema.partial();
var listHospitalsQuerySchema = paginationQuerySchema.extend({
  q: import_zod11.z.string().max(120).optional()
});

// src/modules/hospitals/hospital.routes.ts
var hospitalsRouter = (0, import_express6.Router)();
hospitalsRouter.use(authenticate);
hospitalsRouter.get("/", validate({ query: listHospitalsQuerySchema }), list2);
hospitalsRouter.get("/:id", getOne2);
hospitalsRouter.post("/", requireRole("ADMIN"), validate({ body: createHospitalSchema }), create3);
...
hospitalsRouter.delete("/:id", requireRole("ADMIN"), remove2);
...
async function initiatePayment(patientId, input) {
  const request = await prisma.emergencyRequest.findFirst({
    where: { id: input.requestId },
  ...
  const payment = pending ? await prisma.payment.update({
    where: { id: pending.id },
...
async function handleSuccessCallback(sessionId) {
...
async function handleCancelCallback(sessionId) {
  const payment = await prisma.payment.findFirst({
    where: { stripeSessionId: sessionId },
    select: PAYMENT_SELECT
  });
...
async function listMyPayments(patientId, query) {
...
var myPayments = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
...
var cancelCallback = catchAsync(async (req, res) => {
  const sessionId = req.query.sessionId;
  if (!sessionId) {
    throw AppError.badRequest("Missing sessionId query parameter");
  }
...
var initiatePaymentSchema = import_zod12.z.object({
  requestId: import_zod12.z.string().cuid()
});
var listPaymentsQuerySchema = paginationQuerySchema.extend({
  status: import_zod12.z.enum(["PENDING", "PAID", "FAILED", "REFUNDED"]).optional()
});
...
paymentsRouter.get("/:id", getOne3);
var paymentCallbackRouter = (0, import_express7.Router)();
paymentCallbackRouter.get("/success", successCallback);
paymentCallbackRouter.get("/cancel", cancelCallback);
var paymentWebhookRouter = (0, import_express7.Router)();
paymentWebhookRouter.post("/", import_express7.default.raw({ type: "application/json" }), webhook);
...
function assertCanView(request, requester) {
  const isOwner = request.patientId === requester.id;
  const isAssignedDriver = request.driverId === requester.id;
  const isAdmin = requester.role === "ADMIN";
  if (!isOwner && !isAssignedDriver && !isAdmin) {
...
function scopeForRequester(requester) {
...
async function createRequest(patientId, input) {
...
async function listRequests(requester, query) {
  ...
  const allowedSortFields = ["requestedAt", "priority", "status"];
...
async function assignRequest(requestId, adminId, input) {
  return prisma.$transaction(async (tx) => {
    ...
    await tx.requestStatusLog.create({
      data: {
        ...
        fromStatus: "PENDING",
        toStatus: "ASSIGNED",
        note: input.driverId ? "Ambulance and driver assigned" : "Ambulance assigned, driver auto selected"
      }
    });
    return updated;
  });
}
async function transitionStatus(requestId, actor, input) {
  return prisma.$transaction(async (tx) => {
    const request = await tx.emergencyRequest.findFirst({ where: { id: requestId } });
    if (!request) {
      throw AppError.notFound("Emergency request not found");
...
async function cancelRequest(requestId, actor, input) {
  return prisma.$transaction(async (tx) => {
    const request = await tx.emergencyRequest.findFirst({ where: { id: requestId } });
    if (!request) {
      throw AppError.notFound("Emergency request not found");
    ...
    const cancellable = ["PENDING", "ASSIGNED", "EN_ROUTE_PICKUP"];
...
async function listMyAssignedRequests(driverId, query) {
...
var list3 = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
  const result = await listRequests(req.user, req.validatedQuery);
  sendResponse(res, { message: "Requests fetched", data: result });
});
var getOne4 = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
  const request = await getRequest(req.params.id, req.user);
  sendResponse(res, { message: "Request fetched", data: { request } });
});
var assign = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
...
var myAssigned = catchAsync(async (req, res) => {
  if (!req.user) throw AppError.unauthorized();
...
var createRequestSchema = import_zod13.z.object({
  pickupAddress: import_zod13.z.string().min(5).max(250),
  pickupLat: import_zod13.z.number().min(-90).max(90),
  pickupLng: import_zod13.z.number().min(-180).max(180),
  priority: import_zod13.z.enum(["CRITICAL", "HIGH", "NORMAL"]).default("NORMAL"),
  destinationHospitalId: import_zod13.z.string().cuid().optional()
});
var listRequestsQuerySchema = paginationQuerySchema.extend({
  ...
  priority: import_zod13.z.enum(["CRITICAL", "HIGH", "NORMAL"]).optional(),
  q: import_zod13.z.string().max(250).optional()
});
var assignRequestSchema = import_zod13.z.object({
  ambulanceId: import_zod13.z.string().cuid(),
  driverId: import_zod13.z.string().cuid().optional()
});
var updateStatusSchema = import_zod13.z.object({
  status: import_zod13.z.enum(["EN_ROUTE_PICKUP", "PICKED_UP", "EN_ROUTE_HOSPITAL", "COMPLETED"]),
  note: import_zod13.z.string().max(250).optional(),
  destinationHospitalId: import_zod13.z.string().cuid().optional()
});
var cancelRequestSchema = import_zod13.z.object({
  cancelReason: import_zod13.z.string().min(3).max(250)
});

// src/modules/requests/request.routes.ts
var requestsRouter = (0, import_express8.Router)();
...
requestsRouter.get("/:id", getOne4);
requestsRouter.post("/", requireRole("PATIENT"), validate({ body: createRequestSchema }), create4);
requestsRouter.post(
  "/:id/assign",
  requireRole("ADMIN"),
...
requestsRouter.patch("/:id/status", validate({ body: updateStatusSchema }), updateStatus2);
requestsRouter.post("/:id/cancel", validate({ body: cancelRequestSchema }), cancel);

// src/modules/users/users.routes.ts
var import_express9 = require("express");
var usersRouter = (0, import_express9.Router)();
...
var healthRouter = (0, import_express10.Router)();
healthRouter.get(
  "/",
...
// src/app.ts
function createApp() {
  const app2 = (0, import_express11.default)();
  ...
  app2.use("/api/v1/payments/webhook", paymentWebhookRouter);
  app2.use(import_express11.default.json({ limit: "1mb" }));
  app2.get("/", (_req, res) => {
    res.json({ success: true, message: "Ambulance dispatch API is running", data: null });
  });
  app2.use("/api/v1/health", healthRouter);
  app2.use("/api/v1/auth", authRouter);
  app2.use("/api/v1/users", usersRouter);
  app2.use("/api/v1/hospitals", hospitalsRouter);
  app2.use("/api/v1/ambulances", ambulancesRouter);
  app2.use("/api/v1/requests", requestsRouter);
  app2.use("/api/v1/driver", driverRouter);
  app2.use("/api/v1/admin", adminRouter);
  app2.use("/api/v1/payments/callback", paymentCallbackRouter);
  app2.use("/api/v1/payments", paymentsRouter);
  app2.use("/api/v1/feedback", feedbackRouter);
